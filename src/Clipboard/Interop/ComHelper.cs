...
namespace Clipboard.Interop
{
    ...
    internal static class ComHelper
    {
        ...
        internal static int GetComStream(IntPtr hGlobal, out System.Runtime.InteropServices.ComTypes.IStream comStream)
        {
            return Win32NativeMethods.CreateStreamOnHGlobal(hGlobal, true, out comStream);
        }
